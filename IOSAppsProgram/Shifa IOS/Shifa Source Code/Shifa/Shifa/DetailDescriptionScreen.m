...
@interface DetailDescriptionScreen ()

@end

@implementation DetailDescriptionScreen
...
-(void)getDetailScreenData{
    ...
    NSString *quaryString = [NSString stringWithFormat:@"SELECT _id,%@,%@,%@ FROM tbl_rem_info where upper(rem) = '%@' COLLATE NOCASE",data,kent,allen,app.strSelectedRowStringAtMaterialMedicaVc2];
