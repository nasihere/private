...
angular.module('App.Admin').controller('RegistrationCtrl', function ($scope, api,
    ...
    $scope.RoleList = [];
    api.get(ConsoleConfig.GETROLES, {}).then(function (res) {
    ...
    $scope.SubmitRegister = function () {
        ...
        api.post(ConsoleConfig.REGISTER, $scope.bindRegister).then(function (res) {
...
//        $rootScope.$broadcast(AUTH_EVENTS.logoutSuccess);
    ...
    $scope.ApproverProfile = function() {
        ...
        api.post(ConsoleConfig.SaveAccount, $scope.ngPopupItem).then(function (res) {
    ...
    $scope.GetUserList = function(model) {
        api.post(ConsoleConfig.UserList, model).then(function (res) {
