    ...
    private void StartUp() {
        try {
            ...
            if (GetPreferenceValue("gcmregset").equals("true")) {
                ...
                try {
                    if (!GetPreferenceValue(".XXXXXXX").equals("0")) {
                        ...
                        nameValuePairs.add(new BasicNameValuePair(".XXXXXXX", GetPreferenceValue(".XXXXXXX")));
                        Super_Library_URLV2 SLU1 = new Super_Library_URLV2("http://kent..XXXXXXX/app_php/gcmreg.php", nameValuePairs, ((Activity) ctx));
