        ...
        protected void onPostExecute(String result) {
            ...
            if (CallFunctionAfterResponseComplete.equalsIgnoreCase("SetUserAccountAsPaid")) {
                ...
                if (!Response.equals("")) {
                    ...
                    // **Nasir uncomment when deployed  SLAc.ShowScreen("HomeScreen");
                ...
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_contact", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetShifaPvtChat")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetShifaPublicChat")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetPvtMsgBetweenUsers")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetShifaDiscussionChat")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetShifaDiscussionOthers")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetShifaDiscussionBetweenUsers")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("DoResponseActionForPvtPublicChatSend")) {
                SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response, ".XXXXXXXapp_chat", CallFunctionAfterResponseComplete);
            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPGetSettingsContactInfo")) {
                if (!Response.equals("")) {
                    SLAc.SavePreference(SLAc.CONST_USER_INFO_FRIEND, SLAc.GetValueByKey("info", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_OCCUPATION_FRIEND, SLAc.GetValueByKey("occupation", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_NAME_FRIEND, SLAc.GetValueByKey("fname", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_COUNTRY_FRIEND, SLAc.GetValueByKey("country", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_CITY_FRIEND, SLAc.GetValueByKey("city", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_EMAIL_FRIEND, SLAc.GetValueByKey("email", Response));
                    SLAc.SavePreference(SLAc.CONST_USER_PAID_FRIEND, SLAc.GetValueByKey("paiduser", Response));
                    SLAc.SavePreference("FriendProfileLoaded", "true"); // this line is important this will update UI thread

                }

            } else if (CallFunctionAfterResponseComplete.equalsIgnoreCase("WSChatPHPAnyNewChat")) {
                // Log.e("SLR", "WSChatPHPAnyNewChat " + Response);
                if (!Response.trim().equals("")) {
                    //  Log.e("SLR","WSCHAT PGHP NEW in");

                    SLAc.SavePreference("NewChat", "true");
                }
                // SLAc.SaveWSChatPHPGetUserPvtPublicChat(Response,".XXXXXXXapp_chat",CallFunctionAfterResponseComplete);
            } else {
                Log.e("SLR", "Result " + result);
