    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("url", "http://kent..XXXXXXX/app_php/howtouseshifa/howtouseshifa.php?request=buynow");
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (SLAc.isPaidMember() == true)
                    intent.putExtra("url", "http://kent..XXXXXXX/app_php/buynow/buynowwebpayment.php?.XXXXXXX=" + SessionID + "&ispaid=true");
                else
                    intent.putExtra("url", "http://kent..XXXXXXX/app_php/buynow/buynowwebpayment.php?.XXXXXXX=" + SessionID);
                startActivity(intent);
