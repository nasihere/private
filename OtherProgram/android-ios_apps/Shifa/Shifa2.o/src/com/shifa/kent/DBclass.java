...
public class DBclass {
    ...
    public void KentItemSeleted(String SelectValue, int _id) {
        Log.e("Qyert", "UPDATE .XXXXXXX set selected = '" + SelectValue + "' where _id = " + _id);
        db.getReadableDatabase().execSQL("UPDATE .XXXXXXX set selected = '" + SelectValue + "' where _id = " + _id);
        Log.e("Qyert", "Done");
    ...
    public void KentShifaInData(String jsonValue, String Category, String Book) {
        try {
            ...
            String qry = "UPDATE .XXXXXXX set json = '" + jsonValue + "' where upper(book) = '" + Book.toUpperCase() + "' and upper(Name) = '" + Name.toUpperCase() + "' and upper(categoy) = '" + Cat.toUpperCase() + "'";
            Log.e("runner", qry);
