...
public class login extends BlundellActivity implements MainMenu {
    ...
    ShifaDepartment ShifaDepartment;
    String FBHashKey = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShifaSessionID = GetPreferenceValue(".XXXXXXX_Migration");
        ...
        if (ShifaSessionID != "0" || AutoFBLogin != "0") {
            SetPreferenceValue(".XXXXXXX_Migration", "");
            SetPreferenceValue("FBLoginRequest", "");
            FBLogin();
    ...
    private void LoginCreate() {
        ...
        ShifaDepartment = new ShifaDepartment(ctx);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ShifaDepartment.GetLoginToHomeScreen(edtemailid.getText().toString(), edtpass.getText().toString());


                //}

                // task.execute(new String[] {
                // "http://kent..XXXXXXX/app_php/app_login.php?email=nasihere@gmail.com&password=111"});
        ...
        tvLoginGuest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(".XXXXXXX", "123456789");
        ...
        tvLoginHelp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("url",
                        "http://kent..XXXXXXX/app_php/howtouseshifa/howtouseshifa.php");
                startActivity(intent);
            }
        });
    }
    ...
    public void Dialog() {
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                task.execute(new String[]{"http://kent..XXXXXXX/app_php/app_forgotpassword.php?email="
                        + value});
                //}
                ...
                Request.newMeRequest(session, new GraphUserCallback() {
                    ...
                    public void onCompleted(GraphUser user, Response response) {
                        ...
                        if (user != null) {
							...
							*/
                            String url = "";
                            url = "http://kent..XXXXXXX/app_php/app_reg_1.php?fname="
                                    + FirstName + "&lname=" + LastName + "&.XXXXXXX=" + FB_ID + "&email=" + Email + "&dob=" + DOB + "&sex="
            ...
            try {
                ...
                if (login.equals("-1")) {
                    ...
                    if (tmp[4].equalsIgnoreCase("Success")) {
                        ...
                        SharedPreferences.Editor editor = getSharedPreferences(
                                "AppNameSettings", 0).edit();
                        editor.putString(".XXXXXXX", profiledata[0]);
