                        ...
                        try {
                            ...
                            if (bmp != null) {
                                ...
                                BitmapDisplayer bmpDisplayer =
                                        new BitmapDisplayer(bmp, imageToLoad.imageView, R.drawable.ic_chat_student);
                                ...
                                BitmapDisplayer bmpDisplayer =
                                        new BitmapDisplayer(null, imageToLoad.imageView, R.drawable.ic_chat_student);
                            }
                        } catch (Exception ex) {
                        }
                    }
    ...
    private class BitmapDisplayer implements Runnable {
        ...
        public void run() {
            if (bitmap != null)
                ...
                imageView.setImageResource(R.drawable.ic_chat_student);
