...
public class activity_r_repertory extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iHit++;
        populatedatabase("SELECT distinct _id,book rem,'' status FROM .XXXXXXX group by book", "Home", false);
        ...
        myList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View view, int position,
                ...
                if (Category.equalsIgnoreCase("Kent") || Category.equalsIgnoreCase("Boenninghausens")) {
                    ...
                    book = Category;
                    iHit++;
                    populatedatabase("SELECT _id,rem,'' status FROM .XXXXXXXrem_info where level = '0' order by rem ", "Home", false);
                    HomePage = false;
                    ...
                    populatedatabase("SELECT _id,rem,status FROM .XXXXXXXrem_info where level = '1' and rem  like  '" + Category + "%' order by rem ", "Home", false);
                    HomePage = false;
                } else {
                ...
                public boolean onQueryTextSubmit(String query) {
                    if (query.length() != 0) {
                        try {
                            ...
                            populatedatabase("SELECT _id,rem,status FROM .XXXXXXXrem_info where level = '1' and rem  like  '%" + query + "%' order by rem ", "Home", false);

                        } catch (Exception ex) {
                            Log.e("Error app", "Error Action bar search 1 ");
                        }
                        // handle search here
                        return true;
                    }
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                try {
                    ...
                    populatedatabase("SELECT _id,rem,status FROM .XXXXXXXrem_info where level = '1' and rem  like  '%" + value + "%' order by rem ", "Home", false);
                } catch (Exception ex) {
                    Log.e("Error app", ex.toString() + " Error Action bar search");
                }
