...
function toArray(string) {
	...
	for(i=0;i<lines.length;i++){
		...
		symptoms[i] = "<a href='#ClearButton' class='red bolder' onclick='javascript:deleteitem(this)' data-remedies='" + lines[i] + "'>X</a> " + test[1];
		var r = test[0].split(':');
		var testr = r;
