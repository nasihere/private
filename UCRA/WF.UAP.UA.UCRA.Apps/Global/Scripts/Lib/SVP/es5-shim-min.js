...
(function(t, e) {
    ...
    var s = r.call;
    var f = e.toString;
    var c = function(t) { return e.toString.call(t) === "[object Function]"; };
    var h = function(t) { return e.toString.call(t) === "[object RegExp]"; };
    ...
    var O = function de(t) { return t >>> 0; };
    ...
    var A = false;
    if (t.reduce) {
        A = typeof t.reduce.call("es5", function(t, e, r, n) { return n; }) === "object";
    }
    m(t, {
    ...
    var P = false;
    if (t.reduceRight) {
        P = typeof t.reduceRight.call("es5", function(t, e, r, n) { return n; }) === "object";
    }
    m(t, {
    ...
    var z = !{ toString: null }.propertyIsEnumerable("toString"), $ = function() {}.propertyIsEnumerable("prototype"), G = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], B = G.length;
    m(Object, {
        keys: function Me(t) {
    ...
    var H = Object.keys && function() { return Object.keys(arguments).length === 2; }(1, 2);
    var L = Object.keys;
    m(Object, {
        keys: function Fe(e) {
            if (g(e)) {
    ...
    var K = false;
    try {
        K = Date.prototype.toJSON && new Date(NaN).toJSON() === null && new Date(X).toJSON().indexOf(Y) !== -1 && Date.prototype.toJSON.call({ toISOString: function() { return true; } });
    } catch (Q) {
    }
    if (!K) {
    ...
    if (!Date.parse || te || W || !V) {
        Date = function(t) {
            ...
            function a(e) { return Number(new t(1970, 0, 1, 0, 0, 0, e)); }
    ...
    if (!Date.now) {
        Date.now = function Ce() { return(new Date).getTime(); };
    }
    ...
    var re = {
        ...
        pow: function Ze(t, e, r) { return e === 0 ? r : e % 2 === 1 ? Ze(t, e - 1, r * t) : Ze(t * t, e / 2, r); },
        log: function Je(t) {
            var e = 0;
            while (t >= 4096) {
                e += 12;
    ...
    var ae = function() {
        var t = [];
        "x".replace(/x(.)?/g, function(e, r) { t.push(r); });
    ...
    m(n, { substr: function Be(t, e) { return oe.call(this, t < 0 ? (t = this.length + t) < 0 ? 0 : t : t, e); } }, le);
    var ue = "	\n\f\r \xa0\u1680\u180e\u2000\u2001\u2002\u2003" + "\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028" + "\u2029\ufeff";
    var se = "\u200b";
    var fe = "[" + ue + "]";
