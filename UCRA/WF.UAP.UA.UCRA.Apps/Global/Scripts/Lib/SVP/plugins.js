...
- hash-change by ben alman, 
- jquery-hoverintent, 
- jquery masked-input plugin
- ThreeDots jquery text truncate plugin
- jQuery Cookie plugin
- jquery UI Touch Punch (support touch events for jquery UI - sig capture)
- jquery signature(capture)
- jquery/bootstrap validation
- jquery DATATABLES 1.9.4
- JavaScript - Natural Sort algorithm for Javascript - Version 0.6 - Released under MIT license - at http://www.overset.com/2008/09/01/javascript-natural-sort-algorithm-with-unicode-support/
*/
...
// HASH CHANGE RECOGNITION VIA BEN ALMAN
/*
...
// *(eric commented out the portion above, $.browser is no longer supported above jquery 1.8.3)
...
(function(e) {
    ...
    e.fn.ThreeDots.update = function(u) {
        var k, t = null;
        var m, j, s, q, o;
        var l, i;
        var r, h, n;
        if ((typeof u == "object") || (u == undefined)) {
            e.fn.ThreeDots.c_settings = e.extend({}, e.fn.ThreeDots.settings, u);
            var p = e.fn.ThreeDots.c_settings.max_rows;
            if (p < 1) {
                return e.fn.ThreeDots.the_selected;
            }
            var g = false;
            jQuery.each(e.fn.ThreeDots.c_settings.valid_delimiters, function(v, w) {
                if (((new String(w)).length == 1)) {
                    g = true;
                }
            });
            if (g == false) {
            ...
            e.fn.ThreeDots.the_selected.each(function() {
                k = e(this);
                if (e(k).children("." + e.fn.ThreeDots.c_settings.text_span_class).length == 0) {
                    return true;
                }
                ...
                d(k, l, y);
                var v = e(l).text();
                if ((h = e(k).attr("threedots")) != undefined) {
                    e(l).text(h);
                ...
                if (a(k, y) > p) {
                    curr_ellipsis = e(k).append('<span style="white-space:nowrap" class="' + e.fn.ThreeDots.c_settings.e_span_class + '">' + e.fn.ThreeDots.c_settings.ellipsis_string + "</span>");
                    while (a(k, y) > p) {
                        i = b(e(l).text());
                    ...
                    if (t != null) {
                        var w = c(k, y);
                        if ((a(k, y) <= p - 1) || (w) || (!e.fn.ThreeDots.c_settings.whole_word)) {
                            r = e(l).text();
                            if (i.del != null) {
                                e(l).text(r + n);
                            }
                            if (a(k, y) > p) {
                                ...
                                e(l).text(e(l).text() + t);
                                if ((a(k, y) > p + 1) || (!e.fn.ThreeDots.c_settings.whole_word) || (v == t) || w) {
                                    while ((a(k, y) > p)) {
                                        if (e(l).text().length > 0) {
                                            e(l).text(e(l).text().substr(0, e(l).text().length - 1));
                                        } else {
                                            break;
                                        }
                                    }
                ...
                if (x == e(e(k).children("." + e.fn.ThreeDots.c_settings.text_span_class).get(0)).text()) {
                    e(k).children("." + e.fn.ThreeDots.c_settings.e_span_class).remove();
                } else {
                    if ((e(k).children("." + e.fn.ThreeDots.c_settings.e_span_class)).length > 0) {
                        if (e.fn.ThreeDots.c_settings.alt_text_t) {
                            e(k).children("." + e.fn.ThreeDots.c_settings.text_span_class).attr("title", x);
                        }
                        if (e.fn.ThreeDots.c_settings.alt_text_e) {
                            e(k).children("." + e.fn.ThreeDots.c_settings.e_span_class).attr("title", x);
                        }
                    }
                }
            });
    ...
    function c(k, h) {
        if (e.fn.ThreeDots.c_settings.allow_dangle == true) {
            return false;
        }
    ...
    function a(i, j) {
        var g = typeof j;
        if ((g == "object") || (g == undefined)) {
            return e(i).height() / j.lh;
        } else {
            if (g == "boolean") {
                var h = f(e(i));
                return{ lh: h };
    ...
    function b(k) {
        ...
        var h = null;
        var l = null;
        jQuery.each(i, function(m, o) {
            if (((new String(o)).length != 1) || (o == null)) {
                return false;
            }
        ...
        if (g > 0) {
            return{ updated_string: jQuery.trim(k.substring(0, g)), word: h, del: l };
        } else {
            return{ updated_string: "", word: jQuery.trim(k), del: null };
        }
    }

    function f(h) {
        e(h).append("<div id='temp_ellipsis_div' style='position:absolute; visibility:hidden'>H</div>");
...
(function($) {
    var d = {
        options: { background: '#ffffff', color: '#000000', thickness: 2, guideline: false, guidelineColor: '#a0a0a0', guidelineOffset: 50, guidelineIndent: 10, notAvailable: 'Your browser doesn\'t support signing', syncField: null, change: null },
        _create: function() {
            this.element.addClass(this.widgetFullName || this.widgetBaseClass);
            try {
                this.canvas = $('<canvas width="' + this.element.width() + '" height="160">' + this.options.notAvailable + '</canvas>')[0];
        ...
        _refresh: function(a) {
            if (this.resize) {
                var b = $(this.canvas);
                $('div', this.canvas).css({ width: b.width(), height: b.height() });
            }
        ...
        _mouseCapture: function(a) { return!this.options.disabled; },
        ...
        _round: function(a) { return Math.round(a * 100) / 100; },
        toJSON: function() {
            var b = '{"lines":[';
            var c = '';
        ...
        draw: function(a) {
            ...
            $.each(this.lines, function() {
                b.beginPath();
                $.each(this, function(i) { b[i == 0 ? 'moveTo' : 'lineTo'](this[0], this[1]); });
                b.stroke();
            });
            this._changed();
        },
        isEmpty: function() { return this.lines.length == 0; },
        _destroy: function() {
    ...
    if ($.Widget.prototype._getCreateOptions === $.noop) {
        $.extend(d, { _getCreateOptions: function() { return $.metadata && $.metadata.get(this.element[0])[this.widgetName]; } });
    }
    $.widget('kbw.signature', $.ui.mouse, d);
...
(function(X, l, n) {
    var L = function(h) {
        var j = function(e) {
            ...
            function za(a) {
                ...
                c.bind("keyup.DT", function() {
                    for (var c = a.aanFeatures.f,
                        ...
                        g = 0,
                        e = c.length; g < e; g++)c[g] != h(this).parents("div.dataTables_filter")[0] && h(c[g]._DT_Input).val(d);
            ...
            function Ha(a, b, c,
                d, i, f) { if ("" !== b)for (var g = 0, b = ma(b, d, i, f), d = a.aiDisplay.length - 1; 0 <= d; d--)i = Ja(v(a, a.aiDisplay[d], c, "filter"), a.aoColumns[c].sType), b.test(i) || (a.aiDisplay.splice(d, 1), g++); }
            ...
            function T(a) {
                for (var b =
                    ...
                    a = a.aoData,
                    c = 0,
                    d = a.length; c < d; c++)null !== a[c].nTr && b.push(a[c].nTr);
                return b;
            }
        ...
        j.fnVersionCheck = function(e) {
            for (var h = function(e, h) {
                ...
                n = "",
                l = 0,
                t = e.length; l < t; l++)k += h(m[l], 3), n += h(e[l], 3);
