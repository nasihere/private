...
{
    /// <summary>
    /// FDRAccountNoSearchBo class
    /// </summary>
  public class FDRAccountNoSearchBo:SearchBo
  {

      /// <summary>
      /// FDRAccountNoSearchBo Constructor
      /// </summary>
      public FDRAccountNoSearchBo()
        {
            RetailerviewName = Model.Lookup.RetailerSearchViewName.FDRACNoSearch;
        }
        ...
        public SearchApplicationResultsModel Invoke(RequestDto<SearchRequestHeader> request, ref WF.EAI.Model.ViewModels.UFA.ApplicationDataModel dataModel)
        {
            ...
            model = SearchHelper.GetModelObject(SearchCASApplicationByFDRAccNo(appHeader, request));
            return model;
        }

        /// <summary>
        /// SearchCASApplicationByFDRAccNo
        /// </summary>
        /// <param name="appHeader"></param>
        /// <param name="request"></param>
        /// <returns></returns>
        public SearchApplicationResultEntityCollection SearchCASApplicationByFDRAccNo(AppDataHeader appHeader, RequestDto<SearchRequestHeader> request)
        {
            SearchApplicationFDRNumberEntity entity = new SearchApplicationFDRNumberEntity() { FDRAccountNumber = request.RequestHeader.FDRAccountNo, LineOfBusiness = "M" };
            appHeader.TabDataText = JsonConvert.SerializeObject(entity);
            string jsonText = UAP.UA.Global.BLL.SearchHelper.SearchCASApplicationByFDRNumber(appHeader);
