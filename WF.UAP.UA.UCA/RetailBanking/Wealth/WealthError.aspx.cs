...
{
    public partial class WealthError : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            wmgJsonData = setError(SessionID, errormsg, tokenId);
            Response.Expires = -1;
        ...
        private object setError(string SessionID, string errormsg, string accessToken)
        {
          ...
          //  var result = JsonMapper<ResponseDto<UCAModel, DataModel>>.TextToObject(rootJSON);
            ...
            var dto1 = new RequestDto<UCARequestHeader>()
            {
                RequestHeader = new UCARequestHeader()
                {
                    ...
                    UIErrorMessage = errormsg
                }

            };
            var serviceHost = ConfigurationManager.AppSettings["DataServiceHost"];
            var apiName = ConfigurationManager.AppSettings["DataServiceApiError"];
